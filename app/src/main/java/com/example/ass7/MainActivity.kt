...
class MainActivity : AppCompatActivity() {
    ...
    private fun  testEmployeeDate() {
        EmployeeList.add(Employee("Pattharaporn kamkaew" ,"Female", "pattharaporn_k@gmail.com" ,150000))
        EmployeeList.add(Employee("Patthrapornn" ,"Female", "patpat46@kkumail.com" ,100000))
    }
}